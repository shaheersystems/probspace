...
const navItems = [
  ...
  { label: "Mock Interview", url: "/interview" },
  { label: "Get your resume reviewed", url: "/resume-review" },
];
        ...
        navbar={
          <Navbar className={"px-2"}>
            ...
            <NavbarSection>
              ...
              <NavbarItem aria-label="Theme">
                {darkMode ? (
                  <SunIcon onClick={() => setDarkMode(false)} />
                ) : (
                  <MoonIcon onClick={() => setDarkMode(true)} />
                )}
              </NavbarItem>
